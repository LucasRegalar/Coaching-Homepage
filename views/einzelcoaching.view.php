...
<main>
    <section class="hero-section | padding-block-600">
        <div class="hero-section__text | container flex flex-direction-clmn flex-ai-center flex-jc-center text-center">
            <p class="text-neutral-100 fs-primary-hero-heading caps">Einzelcoaching</p>
            <p class="text-neutral-100 fs-secondary-hero-heading">Der Schritt zur Lebensgestaltung</p>
        </div>
    </section>
    ...
    <section class="padding-block-500">
        <div class="container flow">
            <div>
                <h1 class="fs-secondary-heading">Einzelcoaching</h1>
                <p class="fs-fourth-heading caps">Persönliche Entwicklung</p>
            </div>
