...
<body class="radial-gradient">
    <main class="flow flex flex-direction-clmn flex-ai-center padding-top-600 text-center">
        ...
        <p>Es tut mir Leid. Scheinbar ist irgendetwas schief gelaufen und ich konnte Ihre Anfrage nicht erhalten. 
            <br/>Bitte kontaktieren Sie mich direkt über:</p>
        <p>Email: kontakt@coaching-silvina-regalar.de
        <br/>oder
        <br/>Telefon: 0571 779 7756</p>
        <a href="/" class="btn btn--thinn">Startseite</a>

        <p>Kopie ihrer Nachricht:</p>
       <!-- TODO Flashing Nachricht -->
    </main>
</body>
