...
<main>
    <section class="hero-section | padding-block-600">
        <div class="hero-section__text | container flex flex-direction-clmn flex-ai-center flex-jc-center text-center">
            <p class="text-neutral-100 fs-primary-hero-heading caps">Businesscoaching</p>
            <p class="text-neutral-100 fs-secondary-hero-heading">Der Schritt zur Erfolgsgestaltung</p>
        </div>
    </section>
    ...
    <section class="padding-block-500">
        <div class="container flow">
            <div>
                <h1 class="fs-secondary-heading">Businesscoaching</h1>
                <p class="fs-fourth-heading caps">Konfliktlösung schafft Motivation</p>
            </div>
            <div class="grid-even-columns">
                ...
                <div class="beziehungscoaching-img" style="--flow-spacer: 0em">
                    <img class="border-radius-5px" src="/assets/imgs/imgs-high-qual/businesscoaching.jpg"
                        alt="Silvina Regalar im Businesscoaching.">
                </div>
            </div>
        </div>
    </section>
